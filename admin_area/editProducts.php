<?php require_once 'login.php';
  ...
  global $productId;global $productTitle;global $productCollection;global $productCategory;global $productBrand;global $productPrice;global $productDescription;global $productImage;global $productKeys;global $pCatTitle;global $pBrandTitle;
?>
	<!DOCTYPE html>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
			  <td><label>Product Collection</label></td>
			  <td>
				  <select title="Select a collection" name="productCollection" required>
					  <option value="<?php echo $productCollection?>">Selected: <?php echo $pColTitle?></option>
					  <?php
						  global $object;
							  $get_col= "Select * from collections";
							  $run_col = $object->query($get_col );
...
<?php
	if(isset($_POST['update_products']))
	{
		...
		$pCollection = $_POST['productCollection'];
		...
		$updatingProduct = "UPDATE products SET product_col= '$pCollection', product_cat= '$pCategory', product_brand='$pBrand', product_title='$pTitle', product_price='$pPrice',product_description='$pDescription', product_image='$pImage', product_keyword='$pKeyword' WHERE product_id='$proId' ";

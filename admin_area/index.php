	...
	<section id="main_section">
		<aside>
			<div class="category">
				<h2>Functions</h2>
				<ul>
					<li><a href="index.php?newHero">Insert new Hero</a></li>
					<li><a href="index.php?viewHero">View Hero elements</a></li>
					<li><a href="index.php?newProduct">Insert new product</a></li>
					<li><a href="index.php?viewProducts">View all products</a></li>
					<li><a href="index.php?newCollection">Insert a new collection</a></li>
					<li><a href="index.php?viewCollection">View all collections</a></li>
		...
		<div class="product_box">
			<?php
				...
				else if(isset($_GET['newHero']))
				{
				  include_once "addHero.php";
				}
				else if(isset($_GET['viewHero']))
				{
				  include_once "viewHero.php";
				}
				...
				else if(isset($_GET['newCollection']))
				{
					include_once "addCollection.php";
				}
				else if(isset($_GET['viewCollection']))
				{
					include_once "viewCollection.php";
				}
...
<footer>All copyrights&copy;</footer>
</body>
</html>
<?php } ?>
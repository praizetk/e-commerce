                ...
                <div class="col-lg-5">
                    ...
                    <div class="contact-widget">
                        <div class="cw-item">
                            ...
                            <div class="ci-text">
                                <span>Address:</span>
                                <p>Coou, Anambra State, Nigeria.</p>
                            </div>
                        </div>
                        <div class="cw-item">
                            <div class="ci-icon">
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="contact-form">
                        <div class="leave-comment">
                            ...
                            <p>Our staff will call back or email later and answer your questions.</p>
                            <form action="contactUs.php" method="post" class="comment-form">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <input type="text" name="full_name" placeholder="Your full name(s)">
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="submit" class="site-btn" name="comment" value="Contact Us">
                                    </div>
                                </div>
                            </form>
                           </div>
...
<?php
   ...
   if(isset($_POST['comment']))
    {                       
        ...
        $insert_comment = "INSERT INTO contacts (full_name,email,mobile,message,created_at) VALUES ('$full_name','$email','$mobile','$message',NOW())";
        $runcomment = $object->query($insert_comment);
        ...
        {
            echo "<script>alert('Message Sent Successfully! Please wait for 48hours for reply')</script>";

                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="advanced-search">
                            <form method="get" action="search.php" enctype="multipart/form-data" id="searchForm" class="input-group">
                            <input type="text" name="user_value" placeholder="Search a product" required>
                           <input type="submit" class="ti-button" name="search" value="Search">
                            </form>
                        </div>
                    </div>
